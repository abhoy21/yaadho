...
export const LinkPreview = ({ url }: { url: string }): React.JSX.Element => {
  ...
  const renderPreview = (): React.JSX.Element => {
    ...
    switch (type) {
      ...
      default:
        return (
          <div className="max-h-[500px] min-h-[155px] rounded-xl border bg-white/50 p-4 backdrop-blur-sm transition-all duration-200 hover:bg-white/90">
            <Link
              className="group flex items-center justify-between"
              href={url}
              rel="noopener noreferrer"
            ...
            >
              <div className="flex max-h-[500px] min-h-[155px]  items-center gap-3 overflow-hidden">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="max-w-[200px] truncate text-base text-gray-500">
                    {url}
                  </span>
                </div>
              </div>
